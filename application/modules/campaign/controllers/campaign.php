...
class Campaign extends MX_Controller
{
     ...
     * Calculating and parsing correct data for points.
    */
    ...
    // List campaigns grid view (active, past, campaigns by type) or campaign details
    // Put user referral id on url for Proof Of Charity tracking
    ...
    // Organisation upload Campaign's proof of progress progress (image)
